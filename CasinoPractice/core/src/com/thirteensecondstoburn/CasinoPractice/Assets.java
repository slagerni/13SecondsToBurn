...
public class Assets {
    public enum TEX_NAME {
        ...
        LET_IT_RIDE_CIRCLE_1, LET_IT_RIDE_CIRCLE_2, LET_IT_RIDE_CIRCLE_DOLLAR_SIGN, LET_IT_RIDE_PAYTABLE, STATISTICS_BUTTON,
        ROULETTE_BET_CENTER, ROULETTE_BET_LINE, ROULETTE_BET_CORNER
    }
    ...
    Assets() {
        ...
        addLinearTexture("StatisticsButton.png", TEX_NAME.STATISTICS_BUTTON);
        addLinearTexture("RouletteCenterBet.png", TEX_NAME.ROULETTE_BET_CENTER);
        addLinearTexture("RouletteLineBet.png", TEX_NAME.ROULETTE_BET_LINE);
        addLinearTexture("RouletteCornerBet.png", TEX_NAME.ROULETTE_BET_CORNER);
    }
