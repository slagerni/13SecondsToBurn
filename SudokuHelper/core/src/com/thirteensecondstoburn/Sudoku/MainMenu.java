...
public class MainMenu extends Actor {
	...
	public MainMenu (SudokuGame game, Assets assets) {
		this.game = game;
		this.font = assets.getFont();
		this.distanceFieldShader = assets.getDistanceFieldShader();
		backgroundTextureRegion = new TextureRegion(assets.getTexture(Assets.TEX_NAME.HOME));
	}
